...
a boolean flag to track whether multiplications should be processed. The regex for this part is:

```txt
(mul\((\d+),(\d+)\)|do\(\)|dont\(\))
```

The modified `getMulNums` is pretty long, so I'm not going to include it here. However, you can find
it on my
[GitHub](https://github.com/dickeyy/adventofcode/blob/769e9588a1b718979594567f159c673930de29c1/2024/day-3/main.go#L25).
